    ...
    color: Color(0xFF2C2C2E),
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(widget.ImageUrl,height: 200.0,
              fit: BoxFit.cover,),
            SizedBox(height: 20.0,),
            Text('Date: $date',style: TextStyle(color: Colors.white70,fontSize: 15.0),),
            SizedBox(height: 20.0,),
            Text('Author: ${widget.author}',style: TextStyle(color: Colors.white70,fontSize: 15.0),),
            SizedBox(height: 20.0,),
            Text(widget.NewsTitle,style: TextStyle(color: Colors.white70,fontWeight: FontWeight.bold,fontSize: 24.0),),
            SizedBox(height: 20.0,),
            Text(widget.NewsDescription,style: TextStyle(color: Colors.white70,fontSize: 19.0),),
          ],
        ),
      ),
    ),
